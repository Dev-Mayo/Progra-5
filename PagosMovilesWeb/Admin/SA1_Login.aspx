<%@ Page Language="C#" AutoEventWireup="true" Async="true"
         CodeBehind="SA1_Login.aspx.cs"
         Inherits="PagosMovilesWeb.Admin.SA1_Login" %>
<!DOCTYPE html>
<html lang="es">
<head runat="server">
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Sitio Administrativo – Pagos Móviles</title>
...
<div class="card-login bg-white">
    <div class="card-header-custom">
        ...
        <small class="opacity-75">Sitio Administrativo</small>
    </div>
    <div class="p-4">
