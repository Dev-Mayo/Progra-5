<%@ Page Title="Crear Entidad" Language="C#" MasterPageFile="~/MasterPages/Admin.Master"
    AutoEventWireup="true" CodeBehind="Crear.aspx.cs"
    Inherits="PagosMovilesWeb.Admin.SA9_Entidades.Crear" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-card">
        ...
        <asp:TextBox ID="txtId" runat="server" placeholder="Ingrese el ID"></asp:TextBox>
